...
class RuleTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @dataProvider exampleRruleProviderForOccursAt
     */
    public function testOccursAt($string, $expected)
    {
        $this->assertSame($expected, $this->rule->loadFromString($string)->occursAt(new \DateTime('2021-05-17 00:00:00')));
    }

    /**
     * @return array
     */
    public function exampleRruleProviderForOccursAt()
    {
        return array(
            array('FREQ=DAILY;COUNT=10', true),
            array('FREQ=DAILY;UNTIL=19971224T000000Z', false),
            array('FREQ=DAILY;INTERVAL=2', true),
            array('FREQ=DAILY;INTERVAL=10;COUNT=5', true),
            ...
            array('FREQ=MONTHLY;INTERVAL=2;BYDAY=TU', false),
            ...
            array('FREQ=YEARLY;BYDAY=20MO', false),
            array('FREQ=YEARLY;BYWEEKNO=20;BYDAY=MO', false),
            array('FREQ=YEARLY;BYMONTH=3;BYDAY=TH', false),
            ...
            array('FREQ=DAILY;BYHOUR=9,10,11,12,13,14,15,16;BYMINUTE=0,20,40', false),
            array('FREQ=MINUTELY;INTERVAL=20;BYHOUR=9,10,11,12,13,14,15,16', false),
            array('FREQ=MINUTELY;INTERVAL=20;BYHOUR=0', true),
            array('FREQ=MINUTELY;INTERVAL=20;BYMINUTE=0', true),
